{
  initComponent: function(){
    ...
    setInterval(Ext.Function.bind(this.updateAllWidgets, this), 5000);
  },
  ...
  */
  addPortlet: function(config) {
    this.netzkeLoadComponent({name: "netzke_" + this.netzkePortletIndex, params: config, callback: function(c){
